...
public class Tic_Tac_Toe {
    ...
    protected int spacesOccupied; //the number of spaces that are occupied
    ...
    public boolean computerTurn() {
        ...
        //else pick a random spot
            ...
            while (!keepPicking) {
                ...
                switch (move) {
                    case 0:
                        keepPicking = checkSpace(AI, 0, 0);
                        row = 0;
                        col = 0;
                        break;
                    case 1:
                        keepPicking = checkSpace(AI, 0, 1);
                        row = 0;
                        col = 1;
                        break;
                    case 2:
                        keepPicking = checkSpace(AI, 0, 2);
                        row = 0;
                        col = 2;
                        break;
                    case 3:
                        keepPicking = checkSpace(AI, 1, 0);
                        row = 1;
                        col = 0;
                        break;
                    case 4:
                        keepPicking = checkSpace(AI, 1, 1);
                        row = 1;
                        col = 1;
                        break;
                    case 5:
                        keepPicking = checkSpace(AI, 1, 2);
                        row = 1;
                        col = 2;
                        break;
                    case 6:
                        keepPicking = checkSpace(AI, 2, 0);
                        row = 2;
                        col = 0;
                        break;
                    case 7:
                        keepPicking = checkSpace(AI, 2, 1);
                        row = 2;
                        col = 1;
                        break;
                    case 8:
                        keepPicking = checkSpace(AI, 2, 2);
                        row = 2;
                        col = 2;
                        break;
                }
